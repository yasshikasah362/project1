    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 py-16 px-6">
      ...
      <div className="max-w-4xl mx-auto bg-white p-10 rounded-xl shadow-lg mb-12 space-y-6">
        <div className="text-center text-gray-700">
          <h2 className="text-3xl font-semibold text-green-700 mb-4">Become A Distributor</h2>
          <p className="text-lg text-gray-600 leading-relaxed">
            Join us as a distributor and become a part of our growing network. Fill out the form below and submit your request.
          </p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <input
              ...
              className="border border-gray-300 rounded-md p-4 w-full focus:outline-none focus:ring-2 focus:ring-blue-600"
              required
            />
            <input
              type="email"
          ...
          <textarea
            ...
            placeholder="Message *"
            onChange={handleChange}
            className="border border-gray-300 rounded-md p-4 w-full h-32 focus:outline-none focus:ring-2 focus:ring-blue-600"
            required
          ></textarea>
